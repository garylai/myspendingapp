    ...
    internal class SpendingSavingHelper {
        ...
        private let _requestmanager : RequestMaker;
        private let _loginManager : LogInInfoManager;
        ...
        init?(spendingDict: [NSDate : [Spending]],
            dateOrder: [NSDate],
            requestManager: RequestMaker = Util.instance,
            loginManager: LogInInfoManager = Util.instance){
        ...
        func startSaving(completeCallback : ([[Bool]] -> Void)?) -> Bool {
            ...
            _token = _loginManager.getLoginInfo()?.token;
